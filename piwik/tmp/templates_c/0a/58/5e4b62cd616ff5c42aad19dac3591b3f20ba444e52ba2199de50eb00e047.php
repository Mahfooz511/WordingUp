...
class __TwigTemplate_0a585e4b62cd616ff5c42aad19dac3591b3f20ba444e52ba2199de50eb00e047 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            ...
            if (($this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", array()) == 0)) {
                ...
                echo "\"
              ";
            } elseif (($this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", array()) == 1)) {
                // line 7
                echo "title=\"";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_AnnotationOnDate", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")), $this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "note", array())));
                // line 8
                echo "
";
                // line 9
