...
class __TwigTemplate_6a64785b8735ec7a746350c795b37e071d11d0e05010d8d63a055c0926e6e2e5 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["label"] => $context["menu"]) {
            ...
            if ($this->getAttribute($context["menu"], "_html", array(), "any", true, true)) {
                ...
                echo "
        ";
            } elseif ((($this->getAttribute($this->getAttribute($context["menu"], "_url", array()), "module", array()) == (isset($context["currentModule"]) ? $context["currentModule"] : $this->getContext($context, "currentModule"))) && (twig_test_empty($this->getAttribute($this->getAttribute($context["menu"], "_url", array()), "action", array())) || ($this->getAttribute($this->getAttribute($context["menu"], "_url", array()), "action", array()) == (isset($context["currentAction"]) ? $context["currentAction"] : $this->getContext($context, "currentAction")))))) {
                // line 6
                ...
                if (($this->getAttribute($context["lev1UserMenu"], "_hasSubmenu", array(), "any", true, true) && $this->getAttribute($context["lev1UserMenu"], "_hasSubmenu", array()))) {
                    ...
                    foreach ($context['_seq'] as $context["lev2Label"] => $context["lev2Menu"]) {
                        if ((twig_slice($this->env, $context["lev2Label"], 0, 1) != "_")) {
                            // line 50
                            echo "                        ";
                            echo $this->getAttribute($this, "userMenuItem", array(0 => $context["lev2Label"], 1 => $context["lev2Menu"], 2 => (isset($context["currentModule"]) ? $context["currentModule"] : $this->getContext($context, "currentModule")), 3 => (isset($context["currentAction"]) ? $context["currentAction"] : $this->getContext($context, "currentAction"))), "method");
                            echo "
                    ";
                        }
                    }
                    ...
                    // line 53
                    echo "                    ";
                    echo $this->getAttribute($this, "userMenuItem", array(0 => $context["lev1UserLabel"], 1 => $context["lev1UserMenu"], 2 => (isset($context["currentModule"]) ? $context["currentModule"] : $this->getContext($context, "currentModule")), 3 => (isset($context["currentAction"]) ? $context["currentAction"] : $this->getContext($context, "currentAction"))), "method");
                    echo "
                ";
                }
                // line 55
