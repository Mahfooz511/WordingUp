...
class __TwigTemplate_11a0a029a8c0b3371423f4080368d56b394c2a6b50b8db8c59b66c07b635c7b0 extends Twig_Template
{
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["footerIconGroup"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["footerIcon"]) {
                    ...
                    echo "                        <span>
                            ";
                    // line 35
                    if (($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_active_view_icon", array()) && ($this->getAttribute((isset($context["clientSideParameters"]) ? $context["clientSideParameters"] : $this->getContext($context, "clientSideParameters")), "viewDataTable", array()) == $this->getAttribute($context["footerIcon"], "id", array())))) {
                        // line 36
                    ...
                    if (($this->getAttribute((isset($context["clientSideParameters"]) ? $context["clientSideParameters"] : $this->getContext($context, "clientSideParameters")), "viewDataTable", array()) == $this->getAttribute($context["footerIcon"], "id", array()))) {
                        echo "activeIcon";
                    }
